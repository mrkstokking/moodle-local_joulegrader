...
class local_joulegrader_lib_pane_grade_mod_assign_submissions_class extends  local_joulegrader_lib_pane_grade_abstract {
    ...
    /**
     * Processes and validates grading form data. Passes grade data to save_grade() method and redirects.
     *
     * @param $data
    ...
    /**
     * Helper method to get the grade for the user for the assignment
     *
     * @param bool $create
    ...
    /**
     * Loads the grade for the user for the assignment
     *
     * @param bool $create
